...
local url =
   "https://discord.com/api/webhooks/1261396077483921459/eqBmpw7JFSlZfczoiXN23R1qm-xwaYrmJj4Hca92YnpcknyieBuECwjMLXT1-mtPflkl" --pretty obvious what to do here
local data = {
            ["username"] = "Spidey", --webhook name thing idk
			...
			do 
				Messages = {
					...
					["Melancholia"] = {
						...
						"YOU GOT SLAMMED BY Melancholia",
						"SEEMS LIKE YOU NEED Melancholia GG/MELANCHOLIARBLX",
						"GG/MELANCHOLIARBLX GG/MELANCHOLIARBLX GG/MELANCHOLIARBLX",
						"GG/MELANCHOLIARBLX <-- THIS WILL LET YOU COPE WITH YOUR ISSUES",
						"WHAT YOU CANT BEAT MELANCHOLIA?",
						"PRO TIP: BUY MELANCHOLIA",
						"pwned by melancholia",
						"sit nn, get melancholia",
						"melancholia runs da hood",
						"u cant resolve melancholia??",
						"melancholia.lua cop rn dont be broke",
					},
				}
				utx = {
					["symbols"] = {
...
local Window = Library:Window({Size = UDim2.new(0,580,0,600)}) do 
	...
	local misc = Window:Page({Name = "Misc", Weapons = true}) do 
		...
		local chatSpam = Movement:Section({Name = "Chat Spam", Size = 330, Side = "Left"}) do
			...
			chatSpam:Dropdown({Name = "Type", Flag = "Chat Spam Type", Options = {"Melancholia", "Scottish"}, Default = "Melancholia"})
